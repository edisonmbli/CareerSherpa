const dict = {
  ...
  workbench: {
    ...
    statusText: {
      ...
      resume_required_desc: '请先上传简历后再继续。',
      text_too_long: '文本内容过长',
      text_too_long_desc: '请缩短上传文本后重试。',
      job_text_too_long_desc: '请缩短岗位描述后重试。',
      invalid_file_type: '文件类型不支持',
      invalid_file_type_desc: '请上传系统支持的文件格式。',
      file_too_large: '文件体积过大',
      file_too_large_desc: '请上传更小的文件后重试。',
    },
    notification: {
