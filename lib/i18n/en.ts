const dict = {
  workbench_title: 'AI CareerSherpa · Workbench',
  lang_label: 'Language',
  ...
  landing: {
    seo: {
      title: 'AI CareerSherpa | Match · Customize · Interview',
      description:
    ...
    benefits: {
      title: 'Why Choose AI CareerSherpa?',
      items: [
        {
  ...
  resume: {
    ...
    share: {
      ...
      public: {
        bannerText: 'AI CareerSherpa, your dedicated career coach',
        cta: 'Create Yours',
        footerText: 'Powered by AI CareerSherpa',
        printFooter: 'Generated by AI CareerSherpa',
        exportPdf: 'Export',
        print: 'Print',
        metaTitle: 'Professional Resume - AI CareerSherpa',
        ...
        status: {
          ...
          ctaHint: 'Build a polished resume in minutes with AI CareerSherpa.',
        },
      },
    },
    tips: {
