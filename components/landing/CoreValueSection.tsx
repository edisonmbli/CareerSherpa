...
function AbstractEngine() {
    ...
    return (
        <div ref={containerRef} className="relative w-full aspect-[4/3] md:aspect-auto md:h-[500px] flex items-center justify-center p-4">
            <AnimatePresence>
                {isInView && (
                    <motion.svg
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        aria-hidden="true" focusable="false" viewBox="-200 -150 400 300" className="w-full h-full overflow-visible z-10"
                    >
                        <defs>
            ...
            <div className="container mx-auto px-4 relative z-10 max-w-6xl">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
                    ...
                    <motion.div
                        ...
                        className={cn(
                            "w-full rounded-2xl sm:rounded-[2.5rem] overflow-hidden backdrop-blur-2xl relative",
                    ...
                    >
                        ...
                        <div aria-hidden="true" className="absolute inset-0 pointer-events-none bg-[radial-gradient(ellipse_at_center,transparent_0%,rgba(0,0,0,0.02)_100%)] dark:hidden" />
