      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <div className="p-10 md:p-16 rounded-[2rem] bg-white/60 dark:bg-white/[0.03] backdrop-blur-2xl border-[0.5px] border-black/5 dark:border-white/10 shadow-2xl flex flex-col items-center text-center">
            ...
            <p className="max-w-[700px] text-slate-500 dark:text-slate-400 md:text-lg mb-12 leading-relaxed text-balance whitespace-pre-line">
              {subtitle}
            </p>
            ...
            >
              ...
              <div
                aria-hidden="true"
                className="absolute -inset-1 rounded-full animate-pulse bg-cyan-500/20 blur-xl opacity-70 group-hover:opacity-100 transition-opacity duration-500 shadow-[0_0_40px_-10px_rgba(6,182,212,0.8)]"
              />
              ...
              >
                <Link href={signInHref} className="flex items-center gap-3">
                  <Sparkles
                    aria-hidden="true"
                    focusable="false"
                    className="w-6 h-6 text-cyan-400 dark:text-cyan-300"
                  />
                  <span>{t.button}</span>
                  <ArrowRight
                    aria-hidden="true"
                  ...
                  <div
                    aria-hidden="true"
                    className="absolute inset-0 -translate-x-full animate-[shimmer_2.5s_infinite] bg-gradient-to-r from-transparent via-white/20 dark:via-cyan-400/20 to-transparent"
                  />
                </Link>
              </Button>
            </motion.div>
