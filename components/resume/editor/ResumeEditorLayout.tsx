    ...
    >
      ...
      <div className="flex flex-1 overflow-hidden relative w-full">
        ...
        {!isDrawerMode && (
          <div
            className={cn(
              'bg-white dark:bg-zinc-900 border-r dark:border-zinc-800 z-20 shadow-sm transition-all duration-[800ms] ease-in-out overflow-hidden flex-shrink-0 relative flex flex-col',
              isStructureOpen
        ...
        {isDrawerMode && (
          <div
            className={cn(
              'absolute left-0 top-0 bottom-0 z-50 bg-white dark:bg-zinc-900 shadow-2xl border-r dark:border-zinc-800 transition-transform duration-[800ms] ease-out flex flex-col hidden md:flex',
