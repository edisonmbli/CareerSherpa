  ...
  try {
    ...
    if (isMultipart) {
      ...
      if (mimeType.startsWith('image/')) {
        ...
        text = '' // 延后在 service/create 用视觉模型抽取
        charCount = 0
    ...
    await db/* sql */ `
      INSERT INTO job_descriptions (id, user_id, lang, raw_text, source_type, content_type, char_count, media_base64)
      VALUES (${jobId}, ${userKey}, ${lang}, ${text}, ${sourceType}, ${mimeType}, ${charCount}, ${mediaBase64});
    `
