...
export async function POST(req: Request) {
  ...
  const route = '/api/upload/detailed-resume'
  ...
  try {
    ...
    await db/* sql */ `
      INSERT INTO detailed_resumes (id, user_id, lang, original_text, source_type, content_type, char_count, media_base64)
      VALUES (${detailedId}, ${userKey}, ${lang}, ${text}, ${sourceType}, ${mimeType}, ${charCount}, ${mediaBase64});
    `
